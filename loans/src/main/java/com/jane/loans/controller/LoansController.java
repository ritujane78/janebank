...
import com.jane.loans.service.ILoansService;
...
@Tag(
        name = "CRUD REST APIs for Loans in JaneBank",
        description = "CRUD REST APIs in JaneBank to CREATE, UPDATE, FETCH AND DELETE loan details"
)
@RestController
...
public class LoansController {
    ...
    @Operation(
            ...
            description = "REST API to create new loan inside JaneBank"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "201",
    ...
    @GetMapping("/fetch")
    public ResponseEntity<LoansDto> fetchLoanDetails(@RequestHeader("janebank-correlation-id") String correlationId,
